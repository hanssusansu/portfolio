document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        zh: {
            ...
            同時我也想踏出課本，親眼看看所學和實際運作之間，到底差了哪些細節。

            我的實習期間是 2023/7/1 到 2023/8/31，職務是廠務實習生，實習地點在汶萊的 Golden Corporation Sdn Bhd。
            這份實習的設計不是把我固定在單一職位，而是讓我輪調於各個工作站，包含倉儲、生產線、品管實驗室、養蝦場、物流區。
            當走過這些站點，我才明白一間工廠不是由某個部門單獨撐起來的，它更像是一張彼此牽動的網。

            倉儲像是起點，我開始在意物料怎麼被放好，怎麼被找到，怎麼被對上後續需求。
            那是一種很樸素的秩序感，卻也是最容易被忽略的基本功，因為只要起點亂了，後面的每一步都要花更多力氣把它拉回來。

            生產線像是節奏本身，我看見標準化如何讓每一天的產出變得更一致，也看見現場如何用經驗去補齊那些標準沒寫到的角落。
            那一刻才理解，流程不是寫在紙上就會自己運轉，它要靠人去守，靠人去接，靠人把每一次交接都做得更清楚。

            走進品管實驗室時，感受又不一樣。
            在那裡，品質是一種必須被記錄、被判定、也必須被溝通的語言。
            我開始明白，現場和實驗室講的其實是同一件事，只是各自站在不同的位置，用不同的方式讓事情走向更穩的方向。

            養蝦場讓我看見更前段的現實，很多事情不是按下按鈕就會照理想發生。
            物流區則像是把所有努力收束成一次交付，出得去，交得穩，才算把責任完成。
            輪調結束後，我反而更能理解工廠之所以能運作，是因為每個部門願意在自己的位置上，把資訊交代清楚，把責任接住。
    ...
    function updateLanguage(lang) {
        ...
        // 統一：描述永遠由 translations 寫入 data-desc（HTML 不放 data-desc）
        document.querySelectorAll('.skill-tag, .interactive-item').forEach(item => {
    ...
    // ----- Click to open modal (skills + projects + about + internship) -----
    ...
    interactiveItems.forEach(item => {
        item.addEventListener('click', () => {
            ...
            // desc (永遠從 data-desc 拿；data-desc 由 updateLanguage 填入)
